                ...
                <form method="POST" action="/posts/{{ $post->slug }}/comments" class='border border-gray-200 p-6 rounded-xl'>
                    ...
                    <div class="mt-6">
                        <textarea name="body" class=" w-full text-sm focus:outline-none focus:ring"
                            placeholder="Quick, Think something to say" rows="5"></textarea>
                    </div>

                    <div class="flex justify-end mt-6 border-t border-gray-200 pt-6">
                        <button type="submit" class="bg-blue-500 py-2 px-10 text-white uppercase text-xs font-semibold rounded-2xl hover:bg-blue-600">Post</button>
                    </div>
                </form>
