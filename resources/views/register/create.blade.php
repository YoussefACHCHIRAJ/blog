<x-layout>
    <section class="px-6 py-8">
        <main class='max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 rounded-lg p-6'>
            <h1 class="text-center text-lg font-bold">Regsiter!</h1>
            <form method="POST" action="/register">
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full" value="{{ old('name') }}" type="text"
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full" value="{{ old('username') }}" type="text"
